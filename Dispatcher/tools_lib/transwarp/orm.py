...
class Model(dict, metaclass=ModelMetaclass):
    ...
    @classmethod
    def found_rows(cls, cols, where, *args):
        your_query = 'select %s from %s %s' % (cols, cls.__table__, where)
        return db.select_int('select COUNT(*) from (%s) as SQ' % your_query, *args)
